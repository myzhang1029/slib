...
OPT double calculator( ccp infix ) //整合以下功能，提供计算
{
	double result;
...
OPT int prtpn( FILE*fp, cui minimum, cui maximum )
{
	int n=0,i=0,torf=0;
	if ( maximum<=2)
	{
...
OPT int random( cui seed,cui maximum,cui minimum )
{
	srand(seed);
...
OPT int initmem(void *mem)
{
	memset(mem,0,sizeof(mem));
	return 0;
}

OPT int tolwr(int chr)
{
